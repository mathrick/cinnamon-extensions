        ...
        switch (this._action){
            ...
            case "uninstall":
                if (this._appButton.app.get_id()) {
                    for(let i in uninstallScripts) {
                        let executable = Gio.file_new_for_path(uninstallScripts[i]);
                        if (executable.query_exists(null)) {
                            Util.spawnCommandLine(uninstallScripts[i] + " " + this._appButton.app.get_id());
                            this._appButton.menuApplet.menu.close();
                            break;
                        }
                    }
                }
...
SimpleButton.prototype = {
    ...
    _init: function(menuApplet, icon, buttonStyle, labelStyle, name, description) {
        ...
        this.actor.set_style('height: 34px; padding: 0px 7px;');
...
GenericApplicationButton.prototype = {
    ...
    toggleMenu: function() {
        ...
        if (!this.menu.isOpen){
            ...
            if (this.app.get_id()){
                for(let i in uninstallScripts) {
                    let executable = Gio.File.new_for_path(uninstallScripts[i]);
                    if (executable.query_exists(null)) {
...
MyApplet.prototype = {
    ...
    _display : function() {
        ...
        this._searchActiveIcon = new St.Icon({ style_class: 'menu-search-entry-icon',
                                         ...
                                         icon_type: St.IconType.SYMBOLIC });
        this.searchBox = new St.BoxLayout({ style_class: 'menu-search-box', style: 'padding-left: 10px' });
        this.searchEntry = new St.Entry({ name: 'menu-search-entry', style: 'padding-left: 10px;',
        ...
        this.categoriesBox = new St.BoxLayout({ style_class: 'menu-categories-box', style: 'padding-left: 5px;padding-top: 0px;padding-right: 7px;', vertical: true });
        ...
        this.applicationsBox = new St.BoxLayout({ style_class: 'menu-applications-box', style: 'padding-top: 0px;padding-left: 7px;', vertical:true });
        ...
        this.selectedAppBox = new St.BoxLayout({ style_class: 'menu-selected-app-box', style: 'padding-left: 22px;padding-top: 0; padding-bottom: 0;', vertical: true });

        this.selectedAppTitle = new St.Label({ style_class: 'menu-selected-app-title', style: 'text-align: left;', text: "" });
        this.selectedAppBox.add_actor(this.selectedAppTitle);
        this.selectedAppDescription = new St.Label({ style_class: 'menu-selected-app-description', style:'text-align:left;font-size: 10pt;font-style: italic;max-width:250px', text: "" });
        ...
        this.leftPane = new St.BoxLayout({ style: 'padding-right: 10px;', vertical: true });
        this.leftPane.visible = (this.showFavorites || this.showSystemButtons);
